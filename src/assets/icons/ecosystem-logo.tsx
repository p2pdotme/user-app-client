...
/**
 * Ecosystem logo: a bento grid of "app blocks" where the featured block
 * carries the P2P mark — conveying that this app is one of many in the
 * wider P2P protocol ecosystem.
 */
export function EcosystemLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 32 32"
      ...
      <mask id="ecosystem-p2p-cutout">
        {/* featured block area is visible... */}
        <rect x="3" y="3" width="15.5" height="15.5" rx="4.2" fill="white" />
        {/* ...with the P2P mark punched out of it */}
      ...
      <rect
        ...
        rx="4.2"
        fill="currentColor"
        mask="url(#ecosystem-p2p-cutout)"
      />

      {/* surrounding ecosystem blocks */}
