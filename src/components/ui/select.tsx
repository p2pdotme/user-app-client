...
interface SelectProps
  ...
  /**
   * Whether to provide haptic feedback when the select value changes
   * @default true
   */
...
function Select({
  ...
  const handleValueChange = React.useCallback(
    (value: string) => {
      ...
      // Then call the original onValueChange handler
      onValueChange?.(value);
    },
    [disabled, hapticFeedback, onValueChange, triggerSelectionChangeHaptic],
  );
