...
export function PayPlaced({ order }: { order: Order }) {
    ...
    <main className="flex h-full w-full flex-col overflow-y-auto pt-4">
      ...
      <motion.footer
        ...
        <section className="flex w-full flex-col items-center">
          <p className="text-center text-sm">{t("DONT_ASK_FOR_A_QR_YET")}</p>
        ...
        <Card className="mx-4 gap-2 shadow-none sm:gap-4">
          ...
          <CardFooter className="flex flex-col gap-2">
            ...
            />
            {(() => {
              // Use actualFiatAmount directly (includes fees deducted)
