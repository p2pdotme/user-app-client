export const hi = {
  translation: {
    ...
    MY_STAKE_UNSTAKE_IN_DAYS: "{{duration}} के बाद, {{amount}} $P2P आपके वॉलेट में वापस",
    ...
    MY_STAKE_ACTIVITY_TOPPED_UP: "टॉप-अप किया गया",
    ...
    STAKE_COOLDOWN_ALREADY_EXTENDED:
      "स्टेक कूलडाउन पहले ही बढ़ाया जा चुका है",
