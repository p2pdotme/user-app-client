export const hi = {
  translation: {
    ...
    DAILY_SELL_ORDER_PLACEMENT_LIMIT_EXCEEDED:
      "दैनिक बिक्री ऑर्डर प्लेसमेंट सीमा पार हो गई",
    ...
    PERU_QR_FALLBACK_HINT:
      "आवश्यक: CCI और/या Yape/Plin फ़ोन, अगर वे QR स्कैन न कर सकें",
    PERU_QR_INVALID_QR: "यह मान्य Yape/Plin QR नहीं लगता",
    PERU_QR_OPTIONAL_QR: "QR वैकल्पिक है — Yape/Plin स्कैन करके भुगतान के लिए",
    ...
    VEN_QR_FALLBACK_HINT: "आवश्यक: फ़ोन, ID और बैंक, अगर वे QR स्कैन न कर सकें",
    VEN_QR_INVALID_QR: "यह मान्य Pago Móvil QR नहीं लगता",
    VEN_QR_OPTIONAL_QR: "QR वैकल्पिक है — स्कैन करके भुगतान के लिए",
