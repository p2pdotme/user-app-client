export const hi = {
  translation: {
    ...
    PERU_CCI_INVALID:
      "मान्य 20-अंकों का CCI या Yape/Plin फ़ोन (9XXXXXXXX) दर्ज करें",
    PERU_CCI_LABEL: "CCI",
    ...
    SENT: "भेजा गया",
    SEO_DESCRIPTION_BUY:
      "UPI, बैंक ट्रांसफर और अन्य तरीकों से अपनी स्थानीय मुद्रा में USDC खरीदें। तेज़, सेल्फ-कस्टडी और Base पर बिना गैस शुल्क।",
    SEO_DESCRIPTION_DEFAULT:
      "P2P.me एक सेल्फ-कस्टडी ऐप है जिससे आप स्थानीय मुद्रा में USDC खरीद-बेच सकते हैं और किसी भी QR कोड पर USDC से भुगतान कर सकते हैं। Base पर तेज़ फिएट-से-क्रिप्टो स्वैप, बैंक फ्रीज़ की चिंता के बिना।",
    SEO_DESCRIPTION_HELP:
      "P2P.me पर USDC खरीदने, बेचने और भुगतान करने के लिए FAQ, वीडियो गाइड और सहायता।",
    SEO_DESCRIPTION_LOGIN:
      "किसी भी QR कोड पर USDC से खरीदने, बेचने और भुगतान करने के लिए ईमेल, फ़ोन, Google या पासकी से P2P.me में लॉगिन करें।",
    SEO_DESCRIPTION_PAY:
      "किसी भी मर्चेंट का QR कोड स्कैन करें और USDC से भुगतान करें। मर्चेंट को तुरंत स्थानीय मुद्रा मिलती है।",
    SEO_DESCRIPTION_SELL:
      "USDC बेचें और मिनटों में सीधे अपने बैंक खाते या UPI में स्थानीय मुद्रा प्राप्त करें।",
    ...
    VODAFONE_CASH_DETAILS: "Vodafone Cash विवरण",
