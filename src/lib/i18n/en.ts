export const en = {
  translation: {
    ...
    MY_STAKE_TOPUP_BUTTON: "Top up",
    MY_STAKE_TOPUP_TITLE: "Top up stake",
    MY_STAKE_TOPUP_INPUT_LABEL: "Top up amount",
    MY_STAKE_TOPUP_CONFIRM: "Top up",
    P2P_TOPUP_SUCCESS: "$P2P topped up successfully",
